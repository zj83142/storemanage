...
public class FactoryStoreLineBjView extends LinearLayout {
	...
	public FactoryStoreLineBjView(Context context, AttributeSet attrs) {
		super(context, attrs);
		...
		LinearLayout linearLayout = (LinearLayout) inflater.inflate(
				R.layout.factory_store_line_bj_view, this);
